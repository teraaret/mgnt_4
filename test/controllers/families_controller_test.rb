...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference('Family.count') do
      post families_url, params: { family: { body: @family.body, title: @family.title, title_rus: @family.title_rus } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { body: @family.body, title: @family.title, title_rus: @family.title_rus } }
