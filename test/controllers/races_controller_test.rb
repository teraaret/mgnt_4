...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { body: @race.body, family_id: @race.family_id, rus_title: @race.rus_title, title: @race.title } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { body: @race.body, family_id: @race.family_id, rus_title: @race.rus_title, title: @race.title } }
